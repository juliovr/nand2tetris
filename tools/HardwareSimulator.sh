...
then
	...
	java -classpath "${CLASSPATH}:bin/classes:BuiltInChips:bin/lib/Hack.jar:bin/lib/HackGUI.jar:bin/lib/Simulators.jar:bin/lib/SimulatorsGUI.jar:bin/lib/Compilers.jar" HardwareSimulatorMain &
else
...
#	echo Running "$arg1"
	java -classpath "${CLASSPATH}:bin/classes:BuiltInChips:bin/lib/Hack.jar:bin/lib/HackGUI.jar:bin/lib/Simulators.jar:bin/lib/SimulatorsGUI.jar:bin/lib/Compilers.jar" HardwareSimulatorMain "$arg1"
fi
